...
class RobotCommands:
    ...
    def GetAudioFile(self, fileName: str = None, base64: bool = None) -> Response:
    ...
    def GetFileNames(self, directoryName: str = None, device: str = None) -> Response:
    ...
    def GetVideoRecording(self, name: str = None, base64: bool = None) -> Response:
    ...
    def GetObjectTemperature(self, roiLeft: int = None, roiWidth: int = None, roiTop: int = None, roiHeight: int = None,
                             algorithm: int = None, debug: bool = None) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#getobjecttemperature"""
        ...
        return self.GetRequest("temperature/object", json=json)

    def GetSubjectTemperature(self, calROILeft: int = None, calROIWidth: int = None, calROITop: int = None,
                              calROIHeight: int = None, subjectROILeft: int = None, subjectROIWidth: int = None,
                              subjectROITop: int = None, subjectROIHeight: int = None,
                              calTemperature: float = None) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#getsubjecttemperature"""
        ...
        return self.GetRequest("temperature/subject", json=json)

    def GetTemperatureArray(self) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#gettemperaturearray"""

        return self.GetRequest("temperature/array")

    def TakePicture(self, base64: bool = None, fileName: str = None, width: int = None, height: int = None,
                    displayOnScreen: bool = None, overwriteExisting: bool = None) -> Response:
    ...
    def BluetoothSensorDiscoverAndConnect(self, name: str = None, serviceRecord: str = None,
        ...
        return self.PostRequest("bluetooth/rfcomm/discoverandconnect", json=json)
    ...
    def Speak(self, text: str = None, pitch: float = None, speechRate: float = None, voice: str = None,
              flush: bool = None, utteranceId: str = None) -> Response:
    ...
    def SpeakAzure(self, text: str = None, isSSML: bool = None, utteranceId: str = None, speechKey: str = None,
                   speechRegion: str = None, voice: str = None, language: str = None, useCaching: bool = None,
                   trimSilence: bool = None, trimSilenceAggressiveness: int = None) -> Response:
    ...
    def StartAvStreaming(self, url: str = None, width: int = None, height: int = None, frameRate: int = None,
                         videoBitRate: int = None, audioBitRate: int = None, audioSampleRateHz: int = None,
                         userName: str = None, password: str = None) -> Response:
    ...
    def StartRecordingVideo(self, fileName: str = None, mute: bool = None, duration: int = None, width: int = None,
    ...
    def ConnectWiFi(self, networkName: str = None, password: str = None) -> Response:
    ...
    def PerformTargetedUpdate(self, components: str = None, overrideBatteryCheck: bool = None) -> Response:
    ...
    def RenameVideoRecording(self, oldName: str = None, newName: str = None) -> Response:
    ...
    def RestartRobot(self, core: bool = None, sensoryServices: bool = None) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#restartrobot"""

        json = {
            "core": core,
            "sensoryServices": sensoryServices
        }
    ...
    def SaveAudio(self, fileName: str = None, data: str = None, immediatelyApply: bool = None,
    ...
    def SaveImage(self, fileName: str = None, data: str = None, width: int = None, height: int = None,
                  immediatelyApply: bool = None, overwriteExisting: bool = None) -> Response:
    ...
    def SaveSkillFiles(self, file: bytes = None, overwriteExisting: bool = None, uniqueId: str = None,
                       authToken: str = None, type: str = None) -> Response:
    ...
    def SaveVideo(self, fileName: str = None, data: str = None, immediatelyApply: bool = None,
                  overwriteExisting: bool = None) -> Response:
    ...
    def SetBlinkSettings(self, revertToDefault: bool = None, closedEyeMinMs: int = None, closedEyeMaxMs: int = None,
                         openEyeMinMs: int = None, openEyeMaxMs: int = None, blinkImages: str = None) -> Response:
    ...
    def SetImageDisplaySettings(self, layer: str = None, revertToDefault: bool = None, deleted: bool = None,
                                visible: bool = None, opacity: float = None, width: int = None, height: int = None,
                                stretch: str = None, rotation: int = None, horizontalAlignment: str = None,
                                verticalAlignment: str = None, placeOnTop: bool = None) -> Response:
    ...
    def SetLogLevel(self, localLogLevel: str = None, remoteLogLevel: str = None) -> Response:
    ...
    def SetNotificationSettings(self, revertToDefault: bool = None, ledEnabled: bool = None,
                                keyPhraseEnabled: bool = None, keyPhraseFile: str = None) -> Response:
    ...
    def SetTextDisplaySettings(self, layer: str = None, revertToDefault: bool = None, deleted: bool = None,
                               visible: bool = None, opacity: float = None, size: int = None, weight: int = None,
                               wrap: bool = None, horizontalAlignment: str = None, verticalAlignment: str = None,
                               style: str = None, red: bytes = None, green: bytes = None, blue: bytes = None,
                               padLeft: int = None, padTop: int = None, padRight: int = None, padBottom: int = None,
                               rotation: int = None, fontFamily: str = None, placeOnTop: bool = None, width: int = None,
                               height: int = None) -> Response:
    ...
    def SetVideoDisplaySettings(self, layer: str = None, revertToDefault: bool = None, deleted: bool = None,
                                visible: bool = None, opacity: float = None, width: int = None, height: int = None,
                                stretch: str = None, rotation: int = None, horizontalAlignment: str = None,
                                verticalAlignment: str = None, repeat: bool = None,
    ...
    def SetWebViewDisplaySettings(self, layer: str = None, revertToDefault: bool = None, deleted: bool = None,
                                  visible: bool = None, width: int = None, height: int = None, stretch: str = None,
                                  horizontalAlignment: str = None, verticalAlignment: str = None,
                                  placeOnTop: bool = None) -> Response:
    ...
    def TriggerSkillEvent(self, skill: str = None, eventName: str = None, payload: str = None,
    ...
    def UpdateHazardSettings(self, revertToDefault: bool = None, disableTimeOfFlights: bool = None,
                             disableBumpSensors: bool = None, bumpSensorsEnabled: str = None,
                             timeOfFlightThresholds: str = None, disableTiltThreshold: bool = None,
    ...
    def CaptureSpeech(self, overwriteExisting: bool = None, silenceTimeout: int = None, maxSpeechLength: int = None,
                      requireKeyPhrase: bool = None, speechRecognitionGrammar: str = None) -> Response:
    ...
    def CaptureSpeechAzure(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                           maxSpeechLength: int = None, requireKeyPhrase: bool = None, captureFile: bool = None,
                           speechRecognitionLanguage: str = None, azureSpeechKey: str = None,
    ...
    def CaptureSpeechDeepSpeech(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                                maxSpeechLength: int = None, requireKeyPhrase: bool = None,
                                captureFile: bool = None) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#capturespeechdeepspeech"""
        ...
        return self.PostRequest("audio/speech/capturedeepspeech", json=json)

    def CaptureSpeechGoogle(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                            maxSpeechLength: int = None, requireKeyPhrase: bool = None, captureFile: bool = None,
                            speechRecognitionLanguage: str = None, googleSpeechKey: str = None) -> Response:
    ...
    def DisplayImage(self, fileName: str = None, alpha: float = None, layer: str = None,
    ...
    def ChangeLED(self, red: bytes = None, green: bytes = None, blue: bytes = None) -> Response:
    ...
    def DisplayVideo(self, filename: str = None, layer: str = None, isURL: bool = None) -> Response:
    ...
    def Drive(self, linearVelocity: float = None, angularVelocity: float = None) -> Response:
    ...
    def DriveArc(self, heading: float = None, radius: float = None, timeMs: float = None,
    ...
    def DriveTime(self, linearVelocity: float = None, angularVelocity: float = None, timeMs: int = None,
    ...
    def DriveHeading(self, heading: float = None, distance: float = None, timeMs: float = None,
                     reverse: bool = None) -> Response:
    ...
    def DriveTrack(self, leftTrackSpeed: float = None, rightTrackSpeed: float = None) -> Response:
    ...
    def MoveArm(self, arm: str = None, position: float = None, velocity: float = None, duration: float = None,
    ...
    def MoveArms(self, leftArmPosition: float = None, rightArmPosition: float = None, leftArmVelocity: float = None,
                 rightArmVelocity: float = None, duration: float = None, units: str = None) -> Response:
    ...
    def MoveHead(self, pitch: float = None, roll: float = None, yaw: float = None, velocity: float = None,
                 duration: float = None, units: str = None) -> Response:
    ...
    def SendExternalRequest(self, method: str = None, resource: str = None, authorizationType: str = None,
                            token: str = None, arguments: bytes = None, save: bool = None, apply: bool = None,
                            fileName: str = None, contentType: str = None) -> Response:
    ...
    def StartArTagDetector(self, dictionary: int = None, tagSizeMm: float = None) -> Response:
    ...
    def StartCascadeClassifier(self, classifierId: int = None, scaleFactor: float = None, minNeighbors: int = None,
                               minSizeWidth: int = None, minSizeHeight: int = None, maxSizeWidth: int = None,
    ...
    def StartKeyPhraseRecognition(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                                  maxSpeechLength: int = None, captureSpeech: int = None,
    ...
    def StartKeyPhraseRecognitionAzure(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                                       maxSpeechLength: int = None, captureSpeech: int = None, captureFile: bool = None,
                                       speechRecognitionLanguage: str = None, azureSpeechKey: str = None,
                                       azureSpeechRegion: str = None) -> Response:
    ...
    def StartKeyPhraseRecognitionDeepSpeech(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                                            maxSpeechLength: int = None, captureSpeech: int = None,
                                            captureFile: bool = None) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#startkeyphraserecognitiondeepspeech"""
        ...
        return self.PostRequest("audio/keyphrase/startdeepspeech", json=json)

    def StartKeyPhraseRecognitionGoogle(self, overwriteExisting: bool = None, silenceTimeout: int = None,
                                        maxSpeechLength: int = None, captureSpeech: int = None,
                                        captureFile: bool = None, speechRecognitionLanguage: str = None,
    ...
    def StartObjectDetector(self, minimumConfidence: float = None, modelId: int = None, maxTrackerHistory: int = None,
    ...
    def StartPoseEstimation(self, minimumConfidence: float = None, modelId: int = None,
                            delegateType: int = None) -> Response:
    ...
    def StartThermalCamera(self) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#startthermalcamera"""

        return self.PostRequest("cameras/thermal/start")
    ...
    def StopThermalCamera(self) -> Response:
        """https://docs.mistyrobotics.com/misty-ii/reference/rest/#stopthermalcamera"""

        return self.PostRequest("cameras/thermal/stop")

    def TransitionLED(self, red: bytes = None, green: bytes = None, blue: bytes = None, red2: bytes = None,
                      green2: bytes = None, blue2: bytes = None, transitionType: str = None,
    ...
    def DeleteSkill(self, skill: str = None, authToken: str = None) -> Response:
